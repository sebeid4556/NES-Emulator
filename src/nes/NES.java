...
public class NES 
{
	...
	{		
		...
		//EMULATOR.loadROM("rom/test/nestest.nes");	//PASS
		...
		//EMULATOR.loadROM("rom/test/03-immediate.nes");	//CRASH
		//EMULATOR.loadROM("rom/test/04-zero_page.nes");	//FAIL
		//EMULATOR.loadROM("rom/test/15-brk.nes");	//PASS
		//EMULATOR.loadROM("rom/test/16-special.nes");	//???
		//EMULATOR.loadROM("rom/test/08-ind_x.nes");	//FAIL
		//EMULATOR.loadROM("rom/test/09-ind_y.nes");	//FAIL
